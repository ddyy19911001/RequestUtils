package yin.deng.dyrequestutils.okhttplib.helper;
...
import yin.deng.dyrequestutils.okhttplib.annotation.BusinessType;
import yin.deng.dyrequestutils.okhttplib.annotation.RequestType;
...
import yin.deng.dyrequestutils.okhttplib.handler.OkMainHandler;
import yin.deng.dyrequestutils.okhttplib.progress.ProgressRequestBody;

import static yin.deng.dyrequestutils.okhttplib.HttpInfo.ConnectionTimeOut;
import static yin.deng.dyrequestutils.okhttplib.HttpInfo.WriteAndReadTimeOut;
...
class HttpHelper extends BaseHelper{
    ...
    private HttpInfo dealResponse(OkHttpHelper helper,Response res){
        ...
        try {
            if(null != res){
                httpInfo.setResponseHeaders(res.headers());
